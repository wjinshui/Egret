window.skins=window.skins||{};
	...
	return VSliderSkin;
})(eui.Skin);generateEUI.paths['resource/scene/Begin.exml'] = window.BeginSkin = (function (_super) {
	...
	return BeginSkin;
})(eui.Skin);generateEUI.paths['resource/scene/ChooseLevel.exml'] = window.ChooseLevelSkin = (function (_super) {
	__extends(ChooseLevelSkin, _super);
	function ChooseLevelSkin() {
		_super.call(this);
		this.skinParts = ["btnReturnMain"];
		
		this.height = 690;
		this.width = 390;
		this.elementsContent = [this._Scroller1_i()];
	}
	var _proto = ChooseLevelSkin.prototype;
	...
	_proto._Group1_i = function () {
		...
		t.elementsContent = [this.btnReturnMain_i(),this._Image1_i()];
		return t;
	};
	...
	_proto.btnReturnMain_i = function () {
		var t = new eui.Button();
		this.btnReturnMain = t;
		t.label = "返回主界面";
		t.x = 137;
		t.y = 612;
		return t;
	...
	_proto._Image1_i = function () {
		...
		t.height = 47.12;
		t.rotation = 0.31;
		t.scale9Grid = new egret.Rectangle(76,85,458,511);
		t.source = "arraw_png";
		t.width = 30.45;
		t.x = 290;
		t.y = 256;
